## We need these two rules in order to handle cases with
## multiple headers.  Since the cchdrs attr is configurable,
## we cannot iterate over it in a macro, so we cannot
## use genrule; hence these rules.
